...
$status = $row['status'];
  ?>
                                                                <tr bgcolor="#F5F5F5"> 
                                                                  ...
                                                                  <td width="15%"> 
                                                                    <div align="center"> 
                                                                      <a href="javascript:Abrir_Pagina('banners_visualizar.php?id_banner=<?= $row["id_banner"] ?>','scrollbars=yes,width=500,height=600')">
                                                                      <img src="imagens/ed_preview.gif" width="16" height="14" border="0"> 
                                                                      </a> </div>
                                                                  </td>
                                                                  <td width="7%"> 
                                                                    <div align="center"><a href="banners_alterar.php?id_banner=<?= $row["id_banner"] ?>"><img src="imagens/ed_refresh.gif" width="16" height="16" border="0"></a></div>
                                                                  </td>
                                                                  <td width="8%"> 
                                                                    <div align="center"><a href="script_banners.php?acao=excluir&id_banner=<?= $row["id_banner"] ?>"><img src="imagens/ed_delete.gif" width="18" height="17" border="0"></a></div>
                                                                  </td>
                                                                </tr>
                                                                <?} ?>
                                                              </table>
