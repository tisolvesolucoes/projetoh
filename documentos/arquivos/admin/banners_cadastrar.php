                      ...
                      <TR> 
                        <TD align=middle height=30> 
                          <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">efetue 
                            abaixo o cadastro de um novo banner.</font></div>
                        </TD>
                      </TR>
                      <TR> 
                        <TD> 
                                                      ...
                                                      <td height="29" bgcolor="#FFFFFF" valign="top"> 
                                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="textoVerdanaPreto" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
                                                          <tr bgcolor="#FFFFFF"> 
                                                            ...
                                                            <td colspan="2"> 
                                                              <input name="cliente" type="text" class="formAzul" size="40">
                                                            </td>
                                                            <td width="15%"> 
                                                              <div align="right">Largura:</div>
                                                            </td>
                                                            <td width="33%"> 
                                                              <input name="largura" type="text" class="formAzul" size="15" value="468">
                                                              [em pixels] </td>
                                                          </tr>
                                                          <tr> 
                                                            <td colspan="2"> 
                                                            ...
                                                            <td colspan="2"> 
                                                              <input name="url" type="text" class="formAzul" size="40" value="http://">
                                                            </td>
                                                            <td width="15%"> 
                                                              <div align="right">Altura:</div>
                                                            </td>
                                                            <td width="33%"> 
                                                              <input name="altura" type="text" class="formAzul" size="15" value="60">
                                                              [em pixels] </td>
                                                          </tr>
                                                          <tr bgcolor="#FFFFFF"> 
                                                            <td colspan="2"> 
                                                            ...
                                                            <td colspan="2"> 
                                                              <input name="texto_banner" type="text" class="formAzul" size="40">
                                                            </td>
                                                            <td width="15%"> 
                                                              <div align="right"> 
                                                                Abertura:</div>
                                                          ...
                                                          <tr bgcolor="#FFFFFF"> 
                                                            ...
                                                            <td width="23%"> 
                                                              <input name="visualizacoes" type="text" class="formAzul" size="15">
                                                            </td>
                                                            <td width="15%"> 
