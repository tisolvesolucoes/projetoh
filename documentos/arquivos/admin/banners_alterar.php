                                                      ...
                                                      <td height="29" bgcolor="#FFFFFF" valign="top"> 
                                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="textoVerdanaPreto" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
                                                          <tr bgcolor="#FFFFFF"> 
                                                            ...
                                                            <td colspan="2"> 
                                                              <input name="cliente" type="text" class="formAzul" size="40" value='<?= $cliente; ?>'>
                                                            </td>
                                                            <td width="15%"> 
                                                              <div align="right">Largura:</div>
                                                            </td>
                                                            <td width="33%"> 
                                                              <input name="largura" type="text" class="formAzul" size="15" value="<?= $largura; ?>">
                                                              [em pixels] </td>
                                                          </tr>
                                                          <tr> 
                                                            <td colspan="2"> 
                                                            ...
                                                            <td colspan="2"> 
                                                              <input name="url" type="text" class="formAzul" size="40" value="<?= $url; ?>">
                                                            </td>
                                                            <td width="15%"> 
                                                              <div align="right">Altura:</div>
                                                            </td>
                                                            <td width="33%"> 
                                                              <input name="altura" type="text" class="formAzul" size="15" value="<?= $altura; ?>">
                                                              [em pixels] </td>
                                                          </tr>
                                                          <tr bgcolor="#FFFFFF"> 
                                                            <td colspan="2"> 
                                                            ...
                                                            <td colspan="2"> 
                                                              <input name="texto_banner" type="text" class="formAzul" size="40" value="<?= $texto_banner; ?>">
                                                            </td>
                                                            <td width="15%"> 
                                                              <div align="right"> 
                                                                Abertura:</div>
                                                            ...
                                                            <td width="33%"> 
                                                              <select name='tipo_abertura' class='formAzul' id='ativo'>
                                                                <option value="_blank" selected>Página 
                                                                Externa ( _blank)</option>
                                                                <option value="_self" >Própria 
                                                                Página ( _self 
                                                                )</option>
                                                              </select>
                                                            </td>
                                                          ...
                                                          <tr bgcolor="#FFFFFF"> 
                                                            ...
                                                            <td width="16%"> 
                                                              <div align="right"><span class='TextoPretoPequeno'>Visualizações</span>: 
                                                              </div>
                                                            </td>
                                                            <td width="23%"> 
                                                              <input name="visualizacoes" type="text" class="formAzul" size="15" value="<?= $visualizacoes; ?>">
                                                            </td>
                                                            <td width="15%"> 
                                                          ...
                                                          <tr bgcolor="#FFFFFF"> 
                                                            <td colspan="6"> 
                                                              <div align="center"><br>
                                                                <input name="id_banner" type="hidden" value="<?= $id_banner; ?>">
