...
$sql = $pdo->prepare("SELECT * FROM tbl_usuario WHERE idUsuario = ?");
    ...
    if($sql->rowCount() == 1){
      $info = $sql->fetch();
        ...
        if(isset($_SESSION['id']) && $_SESSION['id'] > 0 ){
          ...
          echo $usuario_nome = $campo ['nomeUsuario'];
          die;
        }
    }
?>
                      ...
                      <TR>
                        ...
                        <TD vAlign=middle width=145>
                          <div align="center">
                            <h1>
                              <a href="../../">
                                <img width="50%" src="../../img/logo.jpeg" />
                              </a>
                            </h1>
                          </div>
                        </TD>
                                  ...
                                  <TABLE cellSpacing=0 cellPadding=0 width=518 border=0>
                                    <TBODY>
                                      <TR>
                                        ...
                                        <TD width=61><A href="logout.php"><IMG height=14 src="imagens/res_bt-sair.gif"
                        ...
                        <TD align=middle>
                          ...
                          <TABLE cellSpacing=0 cellPadding=0 width=747 border=0>
                            <TBODY>
                                ...
                                <TD align=middle height=30>
                                  <div align="center">
                                    <font face="Verdana, Arial, Helvetica, sans-serif" size="1">
                                      Verefique abaixo os banners cadastrados no sistema.
                                    </font>
                                  </div>
                                </TD>
                              </TR>
                              <TR>
                                <TD>
                                  <TABLE class=textos cellSpacing=0 cellPadding=0 width=747 border=0>
                                    <FORM name=formident action="" method=get>
                                      <TR>
                                        <TD vAlign=bottom background=imagens/extranet/barra_branco-bg.gif>
                                          <TABLE class=textos cellSpacing=0 cellPadding=0 width="100%" bgColor=#4fa9c7
                                            border=0>
                                            <TBODY>
                                              <TR>
                                                <TD width=10>&nbsp;</TD>
                                                                        ...
                                                                        <td>
                                                                          <table width="100%" border="0" cellpadding="2"
                                                                            ...
                                                                            <tr bgcolor="#F5F5F5">
                                                                              ...
                                                                              <td width="15%">
                                                                                <div align="center">
                                                                                  <a href="javascript:Abrir_Pagina('banners_visualizar.php?id_banner=<?php echo $row["id_banner"]?>','scrollbars=yes,width=500,height=600')">
                                                                                    <img src="imagens/ed_preview.gif"
                                                                              ...
                                                                              <td width="7%">
                                                                                <div align="center"><a
                                                                                    href="banners_alterar.php?id_banner=<?php echo $row["id_banner"];?>">
                                                                                      <img
                                                                                      src="imagens/ed_refresh.gif"
                                                                                      width="16" height="16"
                                                                                      border="0"></a></div>
                                                                              </td>
                                                                              <td width="8%">
                                                                                <div align="center"><a
                                                                                    href="script_banners.php?acao=excluir&id_banner=<?php echo $row["id_banner"];?>"><img
                                                                                      src="imagens/ed_delete.gif"
                                                                                      width="18" height="17"
                                                                                      border="0"></a></div>
                                                                              </td>
                                                                            </tr>
                                      ...
                                      <TR>
                                        <TD bgColor=#ffffff>
                                          <TABLE class=textos cellSpacing=0 cellPadding=0 width="100%" border=0>
                                            <TBODY>
                                              <TR>
                                                <TD align=middle>&nbsp;</TD>
                                              </TR>
